...
agent = Agent(
    ...
    knowledge=PDFUrlKnowledgeBase(
        urls=["https://www.colegiosantoantonio.com.br/revista/receita9C.pdf"],  #["https://agno-public.s3.amazonaws.com/recipes/ThaiRecipes.pdf"],
        vector_db=LanceDb(
            uri="tmp/lancedb",
            table_name="receitas",
...
agent.print_response("Quais são os ingredientes para a preparação do Alfajor Peruano 'King Kong'?", stream=True)
